...
def _sequence_value_loss(batch: TokenLossBatch) -> Tensor:
    """Compare soft and true endpoint values without generating new labels."""
    ...
    # MSB-first normalized decimal: d0/10 + d1/100 + ... .  This is bounded
    # independently of output length and avoids large powers on long prompts.
