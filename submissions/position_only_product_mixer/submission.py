"""Product-aware recurrent mixer with content-independent routing.
...
refinement depth, and outer T. This prevents familiar digit/modulus values from
changing where information is gathered while retaining a general learned
global communication primitive.
"""
