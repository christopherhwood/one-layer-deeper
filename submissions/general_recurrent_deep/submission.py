"""Generic deeply supervised recurrent transition for repeated composition.
...
same complete transition is then reused exactly T times; T is only a compute
control signal and is never exposed to the learned transition.
"""
