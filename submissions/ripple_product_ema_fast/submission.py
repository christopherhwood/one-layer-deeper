"""Product-aware ripple squaring with a faster, stronger EMA teacher.
...
The teacher tracks the rapidly changing early student with decay 0.99, and its
soft consistency weight is 0.30. Architecture, exact losses, temperature, and
ramp are otherwise unchanged. No arithmetic process state or intermediate
label is supplied.
"""
