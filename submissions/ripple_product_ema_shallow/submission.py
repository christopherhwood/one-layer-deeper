"""Product-aware ripple squaring with an efficient shallow EMA teacher.

The student retains four recurrent refinement rounds per modular-square step.
The frozen EMA teacher retains identical parameters and the full outer T path,
but uses two refinement rounds per square. This halves its recurrent scan cost
while preserving a learned refinement transition and endpoint consistency.
